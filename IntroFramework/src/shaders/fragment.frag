...
vec4 GetDistanceScene(vec3 position, in float transparencyPointer)
        {
         ...
         float id0_distance = 1e9;
               ...
               id0_distance  = min(fSphere(posID6,_Objects[63]), id0_distance);
               ...
               id0_distance  = fOpUnionRound(fSphere(posID7,_Objects[73]), id0_distance,0.3);
               ...
               id0_distance  = min(fSphere(posID14,_Objects[143]), id0_distance);
               ...
               id0_distance  = min(fSphere(posID15,_Objects[153]), id0_distance);
         ...
         float id1_distance = 1e9;
               ...
               id1_distance  = min(fSphere(posID4,_Objects[43]), id1_distance);
               ...
               id1_distance  = min(fBox(posID17, vec3(_Objects[173], _Objects[174],_Objects[175])), id1_distance);
         ...
         float id2_distance = 1e9;
               ...
               id2_distance  = min(fBox(posID8, vec3(_Objects[83], _Objects[84],_Objects[85])), id2_distance);
               ...
               id2_distance  = min(fBox(posID11, vec3(_Objects[113], _Objects[114],_Objects[115])), id2_distance);
