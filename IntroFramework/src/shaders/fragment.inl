...
const char *fragment_frag =
 ...
 "uniform float _FOV,_Distance,_LensCoeff,_MaxCoC,_RcpMaxCoC,_MarchMinimum,_FarPlane,_Step;\n"
 ...
 "{"
   "float fogAmount=exp(hitInfo.distanc*-fogDensity);"
   ...
   "fog+=directionalLight.color*pow(dirDot,20.);"
