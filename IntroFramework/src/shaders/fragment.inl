...
const char *fragment_frag =
 ...
 "uniform float _FOV,_Distance,_LensCoeff,_MaxCoC,_RcpMaxCoC,_MarchMinimum,_FarPlane,_Step,fogDensity,_TextId,_Environment,_StepIncreaseByDistance,_StepIncreaseMax;\n"
 ...
 "{"
   "float vali=5.,ps=min(perlinnoise(pos.xz*.1/vali)-.2,0.);"
   "pos.y-=(1.+ps)*_Environment*1000.;"
 ...
 "{"
   "pos.y+=perlinnoise(pos.xz*3.)*.025;"
 ...
 "{"
   "float vali=5.,ps=perlinnoise(pos.xz*.1/vali)-.2;"
   "pos.y-=ps*_Environment*1000.;"
   "vec3 opos=pos,opos_=opos;"
   ...
   "float ss=min(perlinnoise(rpos.xz*.1)*12.,2.),height=0.;"
   "opos.y+=.75;"
   "float dist=fBox(opos+vec3(0.,height,0.),ss*vec3(.08+atan(opos.y*2.)*.02,1.5,.05));"
   "opos.y-=.75;"
   "vec3 o=opos+vec3(0.,height,0.);"
   "pR(opos.yx,5.);"
   "opos*=rotationMatrix(vec3(1.,.2,0.),rpos.x+rpos.z);"
   "dist=fOpUnionRund(dist,fBox(opos+vec3(0.,0.,0.),ss*vec3(.03,.5,.02)),.2);"
   "opos=o;"
   "return dist;"
 "}"
 ...
 "{"
   ...
   "rpos.x=floor(pos.x/vali);"
   "rpos.z=floor(pos.z/vali);"
   "float ss=min(perlinnoise(rpos.xz*.1)*12.,1.5);"
   "vec3 o=opos;"
   "opos=o;"
 ...
 "{"
   ...
   "id1_distance=min(sdCapsule(position,vec3(_Objects[10],_Objects[11],_Objects[12]),vec3(_Objects[13],_Objects[14],_Objects[15]),.1),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[20],_Objects[21],_Objects[22]),vec3(_Objects[23],_Objects[24],_Objects[25]),.06),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[30],_Objects[31],_Objects[32]),vec3(_Objects[33],_Objects[34],_Objects[35]),.08),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[40],_Objects[41],_Objects[42]),vec3(_Objects[43],_Objects[44],_Objects[45]),.1),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[50],_Objects[51],_Objects[52]),vec3(_Objects[53],_Objects[54],_Objects[55]),.06),id1_distance);"
   ...
   "id1_distance=min(sdCapsule(position,vec3(_Objects[100],_Objects[101],_Objects[102]),vec3(_Objects[103],_Objects[104],_Objects[105]),.08),id1_distance);"
   "vec3 posID12=position-vec3(_Objects[120],_Objects[121],_Objects[122]);"
   "id1_distance=fOpUnionRound(fSphere(posID12,_Objects[123]),id1_distance,.12);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[140],_Objects[141],_Objects[142]),vec3(_Objects[143],_Objects[144],_Objects[145]),.1),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[160],_Objects[161],_Objects[162]),vec3(_Objects[163],_Objects[164],_Objects[165]),.15),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[190],_Objects[191],_Objects[192]),vec3(_Objects[193],_Objects[194],_Objects[195]),.04),id1_distance);"
   "vec3 posID20=position-vec3(_Objects[200],_Objects[201],_Objects[202]);"
   "id1_distance=fOpUnionRound(fSphere(posID20,_Objects[203]),id1_distance,.12);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[230],_Objects[231],_Objects[232]),vec3(_Objects[233],_Objects[234],_Objects[235]),.04),id1_distance);"
   "id1_distance=min(sdCapsule(position,vec3(_Objects[240],_Objects[241],_Objects[242]),vec3(_Objects[243],_Objects[244],_Objects[245]),.1),id1_distance);"
