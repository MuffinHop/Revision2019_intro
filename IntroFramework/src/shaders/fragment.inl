...
const char *fragment_frag =
 ...
 "{"
   ...
   "pR(opos.xz,pos.z);"
   "pR(opos.zy,3.14);"
   "float height=GetHeightmap(pos*.04)*.01;"
   "opos.y+=.75;"
 ...
 "{"
   ...
   "if(hitNfo.id.x==material_ID2)"
     "mat.reflectionCoefficient=.11,mat.albedo=vec3(.137028,.584906,.118637),mat.transparency=0,mat.smoothness=.17,mat.reflectindx=.05;"
