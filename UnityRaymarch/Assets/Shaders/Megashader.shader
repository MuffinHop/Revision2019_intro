...
vec4 GetDistanceScene(vec3 position, in float transparencyPointer)
        {
            vec4 result = vec4(10000.0, -1.0, 0.0, 0.0);
               ...
               vec4 distID4 = vec4(id4_distance, material_ID0, position.xz + vec2(position.y, 0.0));
               ...
               vec4 distID8 = vec4(id8_distance, material_ID0, position.xz + vec2(position.y, 0.0));
               ...
               result = DistUnionCombineTransparent(result, distID9, transparencyPointer);
               ...
               result = DistUnionCombineTransparent(result, distID10, transparencyPointer);
               ...
               vec4 distID11 = vec4(id11_distance, material_ID0, position.xz + vec2(position.y, 0.0));
               result = DistUnionCombineTransparent(result, distID11, transparencyPointer);
               ...
               vec4 distID12 = vec4(id12_distance, material_ID0, position.xz + vec2(position.y, 0.0));
               ...
               result = DistUnionCombineTransparent(result, distID14, transparencyPointer);
               ...
               vec4 distID15 = vec4(id15_distance, material_ID0, position.xz + vec2(position.y, 0.0));
               result = DistUnionCombineTransparent(result, distID15, transparencyPointer);
               ...
               result = DistUnionCombineTransparent(result, distID16, transparencyPointer);
               ...
               vec4 distID17 = vec4(id17_distance, material_ID0, position.xz + vec2(position.y, 0.0));
               result = DistUnionCombineTransparent(result, distID17, transparencyPointer);
 ...
 Material GetObjectMaterial(in ContactInfo hitNfo)
        {
            Material mat;
              ...
              mat.reflectionCoefficient = 0.38;
              mat.albedo = vec3(1,1,1);;
              mat.transparency =0;
              mat.smoothness = 0;
              mat.reflectindx = 0.12;
