...
public class SDFObject : MonoBehaviour
{
    ...
    [FormerlySerializedAsAttribute("ShaderComponent")]
    public SDFComponent SDFComponent;
    ...
    protected SDFComponent compShaderComponent;
    protected RM_Surface compSurfaceComponent;
    protected Vector3 previousPosition = new Vector3(-Mathf.Infinity,-Mathf.Infinity, -Mathf.Infinity);
    protected Vector3 previousScale = new Vector3(0f, 0f, 0f);
    protected Vector4 previousRotation = new Vector4(-Mathf.Infinity, -Mathf.Infinity, -Mathf.Infinity, -Mathf.Infinity);
    ...
    protected void LateUpdate()
    {
        ...
        // store mocap data every 12 frames, if changed
