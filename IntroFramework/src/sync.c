       ...
       vec3 DirectionalLightRArray[20] = { 
               ...
               { 4073, 2.00f, 1 }, 
               { 4936, 1234.00f, 0 }, 
               {100000.0f, 1234.00f, 0 }, 
               {2100000.0f, 1234.00f, 0 } 
              }; 
       ...
       vec3 PointLightPositionYArray[20] = { 
               { 340, -14.00f, 0 }, 
               { 595, -9.00f, 0 }, 
               { 596, 1.00f, 0 }, 
               { 873, 1.00f, 0 }, 
       ...
       float Environment;
       vec3 StepIncreaseByDistanceArray[10] = { 
               { 340, 0.00f, 0 }, 
               { 596, 0.03f, 0 }, 
               { 873, 0.01f, 0 }, 
               { 1028, 0.03f, 0 }, 
...
long TempratureNormalizationArrayPointer = 0;
       ...
       PointLightPositionY = setVal(PointLightPositionYArray, row, 20, &PointLightPositionYArrayPointer); 
       ...
       FOV = setVal(FOVArray, row, 18, &FOVArrayPointer); 
       Epsilon = setVal(EpsilonArray, row, 5, &EpsilonArrayPointer); 
       Distance = setVal(DistanceArray, row, 23, &DistanceArrayPointer); 
       LensCoeff = setVal(LensCoeffArray, row, 17, &LensCoeffArrayPointer); 
       ...
       StepIncreaseByDistance = setVal(StepIncreaseByDistanceArray, row, 10, &StepIncreaseByDistanceArrayPointer); 
       StepIncreaseMax = setVal(StepIncreaseMaxArray, row, 11, &StepIncreaseMaxArrayPointer); 
       ...
       Gamma_R = setVal(Gamma_RArray, row, 18, &Gamma_RArrayPointer); 
       Gamma_G = setVal(Gamma_GArray, row, 21, &Gamma_GArrayPointer); 
       Gamma_B = setVal(Gamma_BArray, row, 20, &Gamma_BArrayPointer); 
