...
const char *fragment_frag =
 ...
 "uniform float _FOV,_Distance,_LensCoeff,_MaxCoC,_RcpMaxCoC,_MarchMinimum,_FarPlane,_Step,fogDensity,_TextId,_Environment;\n"
 ...
 "{"
   ...
   "RayMarch(ray,intersection,64,transparencyInformation);"
   "vec3 sceneColor;"
