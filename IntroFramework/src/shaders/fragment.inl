...
const char *fragment_frag =
 ...
 "{"
   ...
   "float dist=fBox(opos+vec3(.2,0.,.2),vec3(.01,.2,.01));"
   "return dist;"
 "}"
 ...
 "{"
   ...
   "if(OBJMAX>17&&17>OBJMIN)"
     "id1_distance=min(sdCapsule(position,vec3(_Objects[170],_Objects[171],_Objects[172]),vec3(_Objects[173],_Objects[174],_Objects[175]),.15),id1_distance);"
   ...
   "if(OBJMAX>23&&23>OBJMIN)"
     "id1_distance=min(sdCapsule(position,vec3(_Objects[230],_Objects[231],_Objects[232]),vec3(_Objects[233],_Objects[234],_Objects[235]),.1),id1_distance);"
