...
const char *fragment_frag =
 ...
 "{"
   ...
   "if(hitNfo.id.x==material_ID1)"
     "mat.reflectionCoefficient=.19,mat.albedo=vec3(1,0,0),mat.transparency=.258824,mat.smoothness=.99,mat.reflectindx=.64;"
 ...
 "{"
   "float delta=.025;"
   "vec3 offset[]={vec3(delta,-delta,-delta),vec3(-delta,-delta,delta),vec3(-delta,delta,-delta),vec3(delta,delta,delta)};"
